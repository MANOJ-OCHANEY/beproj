...
import sys
sys.path.append('/content/drive/My Drive/be proj alternate code/Check3/ehpi_action_recognition')
# sys.path.append("...")
print(sys.path)
...
if __name__ == '__main__':
    ...
    input_provider = ImgDirProvider("/content/drive/My Drive/be proj alternate code/Check3/input1/img_in", image_size=image_size, fps=fps)
    ...
    for frame_nr, frame in enumerate(input_provider.get_data()):
        ...
        cv2.imwrite(os.path.join(get_create_path("/content/drive/My Drive/be proj alternate code/Check3/input1/img_out"), "{}.png".format(str(frame_nr).zfill(5))), img)
